...
fetch_stock_data_task = PythonOperator(
    task_id="fetch_stock_data", python_callable=fetch_task, dag=dag
)

clean_stock_data_task = PythonOperator(
    task_id="clean_stock_data", python_callable=clean_task, dag=dag
)

store_stock_data_task = PythonOperator(
    task_id="store_stock_data", python_callable=store_task, dag=dag
)
...
(
    ...
    >> clean_stock_data_task
    >> store_stock_data_task
    >> success_email_task
)
[
    fetch_stock_data_task,
